...
def normaliza(dicio):
    ...
    return  paissorteado
def jogadas(paissorteado):
    tentativas=20
    while tentativas>0:
        start=input('1.Tentar acertar(1).\n''2.Loja de dicas(2)')
    if start=='1':
        #tentativa pra chutar
        chute= input('Digite um país: ')
        while chute != paissorteado:
            tentativas-=1
            start=input('1.Tentar acertar(1).\n''2.Loja de dicas(2)')

    
    if start=='2':
        1 = input('1. Cor da Bandeira - Preço: 4 tentativas/n'
        dica2= '2. Letra da Capital - Preço: 3 tentativas/n'
        dica3 = '3. Área - Preço: 6 tenativas/n'
        dica4 = "4. População - Preço: 5 tenativas/n "
        dica5 = "5.Continente - Preço: 7 tentativas/n"
        dica0 = "sem dica"

        loja = input('selecione a dica:/n')
